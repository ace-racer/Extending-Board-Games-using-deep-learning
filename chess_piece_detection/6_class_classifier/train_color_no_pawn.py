...
type_locations = {"b": ["bb", "wb"], "n": ["bn", "wn"], "k": ["bk", "wk"], "q": ["bq", "wq"], "r": ["br", "wr"]}
type_name_to_label = { "b":0, "n":1, "r":2, "q": 3, "k":4 }
...
def get_5_class_cnn_model_structure():
    """"""
    model = Sequential()
...
model = get_5_class_cnn_model_structure()
...
filepath = os.path.join(model_folder_name, "5_class_color_cnn.hdf5")
